...
<style>
  ...
  .flow-label { font-size: 0.68rem; color: #475569; margin-bottom: 0.5rem; }
  .flow-steps {
  ...
  .flow-arrow { font-size: 0.75rem; color: #334155; transition: color 0.3s; }
  .flow-arrow.done { color: #22c55e; }
  .flow-hint { font-size: 0.65rem; color: #334155; margin-top: 0.5rem; }
  ...
  .panel-hint { font-size: 0.65rem; color: #334155; }

  /* Examples */
  .examples { display: flex; flex-direction: column; gap: 0.4rem; }
  .examples-label { font-size: 0.68rem; color: #475569; }
  ...
  .input-hint { font-size: 0.62rem; color: #334155; }

  /* Result */
  .tags { display: flex; flex-direction: column; gap: 0.5rem; }
  .tag-row { display: flex; align-items: center; gap: 0.5rem; }
  .tag-label { font-size: 0.7rem; color: #475569; width: 70px; flex-shrink: 0; }
  .tag {
  ...
  .result-section h3 { font-size: 0.75rem; font-weight: 600; color: #64748b; text-transform: uppercase; letter-spacing: 0.05em; }
  ...
  .empty-state {
    ...
    gap: 0.75rem; color: #334155; padding: 3rem 1rem; text-align: center;
  }
  .empty-state p { font-size: 0.85rem; }
  .empty-hint { font-size: 0.72rem; color: #2a3d55; }
